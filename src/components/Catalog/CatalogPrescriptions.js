...
const CatalogPrescriptions = (props) => {
    const prescriptionHeaderRef = useRef(null);
    const prescriptionFooterRef = useRef(null);
    ...
    const [imagesList, setImagesList] = useState(["https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0214/P_W_0bb65c0fedde6da9c85107aa75fbf657.png", "https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0215/P_W_cbea8633efff32f2f7f069e54cc130eb.jpg", "https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0215/P_M_8e5d081d8a9549546ef5267f9fc9c3b2.png"]);
    const [thumbNailImagesList, setThumbNailImagesList] = useState(["https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0214/tn_P_W_0bb65c0fedde6da9c85107aa75fbf657.png", "https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0215/tn_P_W_cbea8633efff32f2f7f069e54cc130eb.jpg", "https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0215/tn_P_M_8e5d081d8a9549546ef5267f9fc9c3b2.png"]);
    const [selectedImagePath, setSelectedImagePath] = useState("https://static1.medplusindia.com:666/displayprescriptionimages/static4/2024/0214/P_W_0bb65c0fedde6da9c85107aa75fbf657.png");
    ...
    const renderThumbNailImages = () => {
        ...
        {validate.isNotEmpty(thumbNailImagesList) && 
    ...
    return (
        <React.Fragment>
            <HeaderComponent ref={prescriptionHeaderRef} className="d-flex justify-content-between align-items-center">
                {/* expand button */}
                <div className="d-flex custom-border-end ms-auto">
                    <button id="expand-icn" className="btn tbn-sm btn-link icon-hover" disabled={validate.isEmpty(imagesList)} onClick={() => (setLightBoxOpen(true))}>
                    ...
                    {/* Left Rotate */}
                    <button id="left-rotate" className="btn tbn-sm btn-link icon-hover" disabled={validate.isEmpty(imagesList)} onClick={() => { setRotate((rotate - 90) % 360); setIsVertical(!isVertical) }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    {/* Right Rotate  */}
                    <button id="right-rotate" className="btn tbn-sm btn-link icon-hover" disabled={validate.isEmpty(imagesList)} onClick={() => { setRotate((rotate + 90) % 360); setIsVertical(!isVertical) }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <g id="rotate-left-icn-24" transform="translate(-101 -120)">
                                <rect id="Rectangle_10427" data-name="Rectangle 10427" width="24" height="24" rx="3" transform="translate(101 120)" fill="none" />
                    ...
                    <button id="zoom-out" className="btn tbn-sm btn-link icon-hover" disabled={validate.isEmpty(imagesList) || scaleFactor <= 1} onClick={() => { setScaleFactor(scaleFactor - 1) }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <button id="zoom-in" className="btn tbn-sm btn-link icon-hover" disabled={validate.isEmpty(imagesList) || scaleFactor >= 5} onClick={() => { setScaleFactor(scaleFactor + 1) }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <BodyComponent className="body-height scroll-on-hover" allRefs={{ "headerRef": prescriptionHeaderRef, "footerRef": prescriptionFooterRef }}>
                {validate.isNotEmpty(selectedImagePath) ?
                    <div ref={imageContainerRef} onLoad={() => calculateImageDimensions()} className="w-100 h-100 d-flex justify-content-center align-items-center">
                        {selectedImagePath.endsWith(".pdf")
                            ...
                            : <img src={selectedImagePath} className="mw-100 mh-100" alt="Image Not found" style={ComputeTransition()} />
                        }
                    </div>
                    : <NoDataFound text={"No Prescription Found!"} />
                }
            </BodyComponent>
            <FooterComponent ref={prescriptionFooterRef}>
...
export default CatalogPrescriptions;
...
export default function CatalogCartCard() {
  ...
  return (
    <React.Fragment>
            <div className="border-bottom selectedItem">
                <div className="h-100 p-12">
                    <div>
                        <div className="d-flex justify-content-between">
                            <div >
                                <a className="text-primary pointer text-decoration-none fw-medium" id="productname" > Rapo D CAP</a>
                                <p className="font-12 text-secondary mb-2">MRP / Pack <span className="rupee">&#x20B9;</span><span className="text-black">00.00</span> <span className="mx-1">|</span> 1 Unit(s) / Pack</p>
                            </div>
                            <UncontrolledTooltip placement="bottom" target={"productname"}>        
                                Rapo D CAP
                            </UncontrolledTooltip>
                            <div>
                            <Button variant="link" className="icon-hover" id="deleteProduct" onClick={deleteCartItem}>
                        ...
                        <div className="d-flex align-items-center justify-content-between justify-content-center row">
                            <div className="col">
                                <div className="d-flex align-items-center">

                                    <div class="form-floating col-7 me-2"> 
                                    {/* <input placeholder=" "  size="sm" aria-label="text input" index="0" autocomplete="off" type="text"  class="form-control"/> */}
                                    <input placeholder=" " aria-label="text input" htmlelementtype="INPUT" index="0" autocomplete="off" type="text" id="customerId" class="form-control"></input>
                                    <label for="Quantity (Packs)">Quantity (Packs)</label>
                                    </div>
                                    <div >
                            ...
                            <div className="col-5 text-end">
                                <p className="mb-0"><span className="fw-light">Total Price </span><span className=""><span className="rupee">&#x20B9;</span><span className="font-weight-bold">53.75</span></span></p>
                            </div>
                        </div>

...
const CatalogLocationModel=(props)=>{
  ...
  return (
    <React.Fragment>
        <Modal className='modal-dialog-centered modal-xl' isOpen={props.openlocationflag}>
            ...
            <ModalBody>
                ...
                {[1, 2, 3, 4, 5, 6,7,8].map((item) => {
                    return (
                        <React.Fragment>
                            <address className='`address-outline address-no-style px-3 store-info rounded cursor-auto three-column m-0'>
                                <div className='d-flex justify-content-between'>
                                    <p className="title" >MEDPLUS PADMARAO NAGAR</p>
                                    <p className='distance'>3.21 KM</p>
                                </div>
                                <p className="text-capitalize mb-3 text-secondary font-12 text-break">No. 6-1-107/1 To 20, S2, Sri Rama Jaya Chandra Enclave, Padmarao Nagar, Secudera-500 025</p>
                                <p className='mb-3 font-12'>Stock Availability : <span>29</span></p>
                                
                                <a className="text-primary btn btn-link btn-sm me-2" style={{'margin-left':'-0.5rem'}}  title="Call to Store" href="tel:+917680932909">
                                ...
                                <a className="text-primary btn btn-link btn-sm"  title="Get Directions" href="javascript:void(0);">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"  className="me-2">
...
export default CatalogLocationModel